...
<div id="content">
    <table width="519">
		...
		<tr>
			...
			<th colspan="3" align="center"><div style="border: 1px solid rgb(153, 153, 255); width: 386px;"><div  id="CaseBarre" style="background-color: {case_barre_barcolor}; width: {case_barre}px;"><font color="#CCF19F">{case_pourcentage}</font></div></th>
		</tr> 
        <tr>
