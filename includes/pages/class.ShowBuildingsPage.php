...
class ShowBuildingsPage
{
	...
	private function ShowBuildingQueue_bak ( $CurrentPlanet, $CurrentUser, &$Sprice = false )
	{
		global $lang;
...
*/
		...
		$parse['field_libre']          = CalculateMaxPlanetFields($CurrentPlanet)-$CurrentPlanet['field_current'];
