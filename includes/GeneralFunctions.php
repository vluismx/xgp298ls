...
function StdUserHeader ($metatags = '')
{
    ...
    $parse['-meta-']    .= "<script type=\"text/javascript\" src=\"scripts/prototype.js\"></script>\n";
    $parse['-meta-']    .= "<script type=\"text/javascript\" src=\"scripts/lightbox.js\"></script>\n";
...
function ShowDate($date, $format){
	...
	$final_date = str_replace("MONTHNAME", $lang['months'][$month_wo_zero], $final_date);
	$final_date = str_replace("MONTHSHORT", $lang['monthshort'][$month_wo_zero], $final_date);
